...
namespace MartinCamen\LaravelRadarr\Client;
...
use MartinCamen\ArrCore\Exceptions\ConnectionException as RadarrConnectionException;
...
/**
 * Laravel HTTP Client adapter for Radarr REST API.
 *
...
class LaravelRestClient implements RestClientInterface
{
     ...
     * @throws RadarrConnectionException
    ...
    protected function request(
        ...
        try {
            ...
            throw RadarrConnectionException::failed(
                $this->config->host,
                $this->config->port,
                $e->getMessage(),
            );
